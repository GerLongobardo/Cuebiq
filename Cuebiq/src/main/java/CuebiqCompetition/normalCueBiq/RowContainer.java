...
public class RowContainer
{
	...
	public MyNode aggregate(Function<Collection<Integer>, Double> F, String... fields) throws MyException
	{
	...
	private MyNode aggregate(Function<Collection<Integer>, Double> F, ArrayList<MyRow> dataset, String name,
	        List<String> fields)
	{
		MyNode ret = new MyNode(name, F.apply(dataset.stream().map(MyRow::getValue).collect(Collectors.toList())));
	...
	public MyNode aggregate2(Function<Collection<Integer>, Double> F, Collection<MyRow> dataset, String name,
	        List<String> fields) {
